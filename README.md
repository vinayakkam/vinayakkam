...
[![Discord](https://img.shields.io/badge/Discord%20Bot%20Dev-%235865F2.svg?style=for-the-badge&logo=discord&logoColor=white)](#)
...
| Feature | Details |
|---|---|
| ⚡ Slash Commands | Modern `/commands` with full interaction support |
| 🛡️ Auto-Moderation | Spam filter, word filter, role-based permissions |
| 🎭 Role Management | Auto-roles, reaction roles, tiered systems |
